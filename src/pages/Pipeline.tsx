          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {pendingMove?.stage === "confirmed"
                ? "Подтверждение фиксирует бронирование и обновляет статус оплаты. Убедитесь, что предоплата получена."
                : pendingMove?.stage === "payment_pending"
                  ? "Гость получит напоминание об оплате, сделка перейдёт в ожидание предоплаты."
